...
import com.jesusfc.spb.security.SimpleGrantedAuthorityMixin;
...
public class JWTServiceImpl implements JWTService {
    ...
    public String createToken(Authentication auth) throws JsonProcessingException {
        ...
        return Jwts.builder()
                ...
                .signWith(Keys.hmacShaKeyFor(getSecretToken().getBytes()))
    ...
    public Claims getClaims(String token) {
        return Jwts.parserBuilder()
                .setSigningKey(getSecretToken().getBytes())
                .build()
    ...
    private String getSecretToken() {
        return Base64.getEncoder().encodeToString("Mi.Super.Clave.Secreta".getBytes());
    }
}
